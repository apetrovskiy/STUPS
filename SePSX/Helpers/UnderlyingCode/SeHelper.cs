...
Console.WriteLine("getWebElement: 00022");
                            ...
                            if (by != null) {
Console.WriteLine("getWebElement: 00023");
...
Console.WriteLine("getWebElement: 00041");
            ...
            //return result;
            return GetDecoratedCollection(result, webElement, @by);
        }
...
//
        ...
        public static void GetWebElementViaJS(PSCmdletBase cmdlet, object[] elements, string tagName)
        {
            ...
            foreach (object inputObject in cmdletGet.InputObject) {
                ...
                cmdlet.WriteObject(
                    cmdlet, 
                    SeHelper.GetDecoratedCollection((ReadOnlyCollection<IWebElement>)scriptResults, null, null));
