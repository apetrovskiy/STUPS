...
namespace SePSXUnitTests.ParamChecks.Transcript
{
    using System;
    ...
    public class StartSeTranscriptCommandTestFixture // TranscriptCmdletBase
    {
...
//                @"C:\1\testfile.txt";
    ...
    public class StartSeRecorderCommandTestFixture // StartSeTranscriptCommand
    {
