...
namespace TMX
{
    ...
    public partial class CommonCmdletBase : PSCmdletBase
    {
        ...
        protected internal new bool UnitTest { get; set; }
        //[Parameter(Mandatory = false)]
        //public new SwitchParameter UnitTest { get; set; }
...
//Console.WriteLine("unittest");
                    if (null == UnitTestOutput) {
//Console.WriteLine("unittest output");
                        UnitTestOutput =
                           new System.Collections.Generic.List<object>();
                    }
...
//    Console.WriteLine("null == outputObject");
//}
//Console.WriteLine(outputObject.GetType().Name);
//if ("TestProject" == outputObject.GetType().Name) {
//    //Console.WriteLine(
//}
                    base.WriteObject(outputObject);
//Console.WriteLine("after normal output");
                }
            }
            catch {}
        }
