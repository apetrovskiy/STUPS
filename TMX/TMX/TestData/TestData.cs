...
namespace TMX
{
    ...
    public static class TestData
    {
        ...
        static TestData()
        {
            ...
            TestPlatforms = new List<TestPlatform>();
        }
...
//                    closingTestResultId != TMX.TestData.CurrentTestResult.Id) {
        ...
        {
Console.WriteLine("setSuiteStatus 000001");
Console.WriteLine("setSuiteStatus: name = " + TestData.CurrentTestSuite.Name);
Console.WriteLine("setSuiteStatus: id = " + TestData.CurrentTestSuite.Id);
            if (null == TestData.CurrentTestSuite)
                TestData.InitCurrentTestScenario();
            
Console.WriteLine("setSuiteStatus 000002");
Console.WriteLine("setSuiteStatus: name = " + TestData.CurrentTestSuite.Name);
Console.WriteLine("setSuiteStatus: id = " + TestData.CurrentTestSuite.Id);
            TestData.SetScenarioStatus(skipAutomatic);
            
Console.WriteLine("setSuiteStatus 000003");
Console.WriteLine("setSuiteStatus: name = " + TestData.CurrentTestSuite.Name);
Console.WriteLine("setSuiteStatus: id = " + TestData.CurrentTestSuite.Id);
            int counterPassedResults = 0;
            int counterKnownIssueResults = 0;
            
Console.WriteLine("setSuiteStatus 000004");
Console.WriteLine("setSuiteStatus: name = " + TestData.CurrentTestSuite.Name);
Console.WriteLine("setSuiteStatus: id = " + TestData.CurrentTestSuite.Id);
            if (TestData.CurrentTestSuite != null && 
                0 < TestData.CurrentTestSuite.TestScenarios.Count) {
                
Console.WriteLine("setSuiteStatus 000005");
Console.WriteLine("setSuiteStatus: name = " + TestData.CurrentTestSuite.Name);
Console.WriteLine("setSuiteStatus: id = " + TestData.CurrentTestSuite.Id);
                foreach (TestScenario scenario in TestData.CurrentTestSuite.TestScenarios) {
                    
Console.WriteLine("setSuiteStatus 000006");
                    switch (scenario.enStatus) {
                        case TestScenarioStatuses.Passed:
                            counterPassedResults++;
                            // 20131001
                            //TestData.CurrentTestSuite.enStatus = TestSuiteStatuses.Passed;
Console.WriteLine("setSuiteStatus 000007");
                            if (TestSuiteStatuses.Failed != TestData.CurrentTestSuite.enStatus)
                                TestData.CurrentTestSuite.enStatus = TestSuiteStatuses.Passed;
Console.WriteLine("setSuiteStatus 000008");
                            break;
                        case TestScenarioStatuses.Failed:
                            TestData.CurrentTestSuite.enStatus = TestSuiteStatuses.Failed;
Console.WriteLine("setSuiteStatus 000009");
                            return;
                            //break;
                        case TestScenarioStatuses.NotTested:
Console.WriteLine("setSuiteStatus 000010");
                            break;
                        case TestScenarioStatuses.KnownIssue:
                            counterKnownIssueResults++;
                            // 20131001
                            //TestData.CurrentTestSuite.enStatus = TestSuiteStatuses.Passed;
Console.WriteLine("setSuiteStatus 000011");
                            if (TestSuiteStatuses.Failed != TestData.CurrentTestSuite.enStatus)
                                TestData.CurrentTestSuite.enStatus = TestSuiteStatuses.Passed;
                            break;
                        default:
...
Console.WriteLine("setSuiteStatus 000012");
                if (0 == counterPassedResults && 0 < counterKnownIssueResults)
                    TestData.CurrentTestSuite.enStatus = TestSuiteStatuses.KnownIssue;

Console.WriteLine("setSuiteStatus 000013");
                // set statistics
                RefreshSuiteStatistics(TestData.CurrentTestSuite, skipAutomatic);
Console.WriteLine("setSuiteStatus 000014");
Console.WriteLine("setSuiteStatus: name = " + TestData.CurrentTestSuite.Name);
Console.WriteLine("setSuiteStatus: id = " + TestData.CurrentTestSuite.Id);
            }
Console.WriteLine("setSuiteStatus 000015");
Console.WriteLine("setSuiteStatus: name = " + TestData.CurrentTestSuite.Name);
Console.WriteLine("setSuiteStatus: id = " + TestData.CurrentTestSuite.Id);
        }
...
Console.WriteLine("addTestSuite: 000005");
                    TestData.TestSuites.RemoveAt(0);
Console.WriteLine("addTestSuite: 000006");
                }
            }
            catch {}
            
Console.WriteLine("addTestSuite: 000007");
            // set time spent on the previous suite
            if (null != TestData.CurrentTestSuite) {
                
Console.WriteLine("addTestSuite: 000008");
                if (DateTime.MinValue != TestData.CurrentTestSuite.Timestamp) {

Console.WriteLine("addTestSuite: 000009");
...
Console.WriteLine("addTestSuite: 000022");
Console.WriteLine("addTestSuite: name = " + TestData.CurrentTestSuite.Name);
Console.WriteLine("addTestSuite: id = " + TestData.CurrentTestSuite.Id);
