...
//            string lastTestScenarioName = string.Empty;
            ...
            if (null == scenarios) return importedTestScenarios;
...
//            string lastTestResultName = string.Empty;
            ...
            if (null == testResults) return importedTestResults;
...
//				lastTestResultName = singleTestResult.Attribute("name").Value;
				...
				try {
					...
					if (null == testResultDetails || !testResultDetails.Any())
						continue;
					testResult.Details = importTestResultDetails(testResultDetails); // , testResult);
				} catch (Exception e) {
...
//		    string lastTestResultDetailName = string.Empty;
		    ...
		    if (null == testResultDetails) return importedTestResultDetails;
