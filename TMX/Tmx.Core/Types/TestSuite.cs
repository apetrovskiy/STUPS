...
namespace Tmx.Interfaces
{
    ...
    public class TestSuite : ITestSuite
    {
        ...
        public TestSuite(string testSuiteName, string testSuiteId)
        {
            ...
            // 20140723
            // addDefaultPlatform();
            this.PlatformId = addDefaultPlatform();
            // 20140713
            // addAutogeneratedTestScenario(Id);
            this.SetNow();
        }
		...
		string addDefaultPlatform()
		{
			...
			return TestData.GetTestPlatform(TestData.DefaultPlatformName, TestData.TestPlatforms.First(tp => tp.Name == TestData.DefaultPlatformName).Id).Id;
		}
