...
//                {"ProcessId", inputObject.Current.ProcessId.ToString()}
                {"Name", inputObject.GetCurrent().Name},
                {"AutomationId", inputObject.GetCurrent().AutomationId},
                {"ControlType", inputObject.GetCurrent().ControlType.ProgrammaticName},
                {"Class", inputObject.GetCurrent().ClassName},
                {"AcceleratorKey", inputObject.GetCurrent().AcceleratorKey},
                {"AccessKey", inputObject.GetCurrent().AccessKey},
                {"BoundingRectangle", inputObject.GetCurrent().BoundingRectangle.ToString()},
                {"FrameworkId", inputObject.GetCurrent().FrameworkId},
                {"HasKeyboardFocus", inputObject.GetCurrent().HasKeyboardFocus.ToString()},
                {"HelpText", inputObject.GetCurrent().HelpText},
                {"IsContentElement", inputObject.GetCurrent().IsContentElement.ToString()},
                {"IsControlElement", inputObject.GetCurrent().IsControlElement.ToString()},
                {"IsEnabled", inputObject.GetCurrent().IsEnabled.ToString()},
                {"IsKeyboardFocusable", inputObject.GetCurrent().IsKeyboardFocusable.ToString()},
                {"IsOffscreen", inputObject.GetCurrent().IsOffscreen.ToString()},
                {"IsPassword", inputObject.GetCurrent().IsPassword.ToString()},
                {"IsRequiredForForm", inputObject.GetCurrent().IsRequiredForForm.ToString()},
                {"ItemStatus", inputObject.GetCurrent().ItemStatus},
                {"ItemType", inputObject.GetCurrent().ItemType},
                {"LocalizedControlType", inputObject.GetCurrent().LocalizedControlType},
                {"NativeWindowHandle", inputObject.GetCurrent().NativeWindowHandle.ToString()},
                {"Orientation", inputObject.GetCurrent().Orientation.ToString()},
                {"ProcessId", inputObject.GetCurrent().ProcessId.ToString()}
            }))
            {
                #region commented
