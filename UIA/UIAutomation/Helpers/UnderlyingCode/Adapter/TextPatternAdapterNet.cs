...
namespace UIAutomation
{
	...
	/// </summary>
	public class MyTextPatternNet : IMySuperTextPattern
	{
		private System.Windows.Automation.TextPattern _textPattern;
		private IUiElement _element;
		
		public MyTextPatternNet(IUiElement element, TextPattern textPattern)
		{
		...
		public MyTextPatternNet(IUiElement element)
		{
		    this._element = element;
		}
...
//		internal MyTextPatternNet(AutomationElement el, SafePatternHandle hPattern) : base(el, hPattern)
//		{
