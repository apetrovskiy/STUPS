...
//        #region Execution Plan
//		public Queue HighlightersQueue { get; set; }
...
//			try {
//				
////Console.WriteLine("Count = " + this.HighlightersQueue.Count.ToString());
//				
//				foreach (Highlighter highLighter in this.HighlightersQueue) {
////Console.WriteLine("next highlighter");
//					highLighter.Dispose();
////Console.WriteLine("next highlighter disposed");
//				}
//				this.HighlightersQueue.Clear();
////Console.WriteLine("the queue cleaned");
//				this.HighlighterNumber = 0;
//			}
//			catch {
////Console.WriteLine("DisposeHighlighers");
//			}
//		}
//		
...
//						(Highlighter)this.HighlightersQueue.Dequeue();
//					try {
...
//                        (Highlighters)(this.HighlighterNumber % 10),
//                        this.HighlighterNumber);
//
//			} else {
//				
...
//                    
//Console.WriteLine((conds[i] as PropertyCondition).Property.ProgrammaticName);
//Console.WriteLine((conds[i] as PropertyCondition).Value.ToString());
                }
            }
            catch {}
        }
