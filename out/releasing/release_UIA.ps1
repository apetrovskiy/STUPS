...
Copy-Item -Path "$($pathToProjectRoot)\UIA\UIAutomationSpy\bin\Release35\*castle*" -Destination "$($pathToProjectRoot)\out\$($DirName)\35"
Copy-Item -Path "$($pathToProjectRoot)\UIA\UIAutomationSpy\bin\Release35\*access*" -Destination "$($pathToProjectRoot)\out\$($DirName)\35"
Copy-Item -Path "$($pathToProjectRoot)\UIA\UIAutomationSpy\bin\Release35\*ninj*" -Destination "$($pathToProjectRoot)\out\$($DirName)\35"
...
Copy-Item -Path "$($pathToProjectRoot)\UIA\UIAutomationSpy\bin\Release35\*castle*" -Destination "$($pathToProjectRoot)\out\$($DirName)\40"
Copy-Item -Path "$($pathToProjectRoot)\UIA\UIAutomationSpy\bin\Release35\*access*" -Destination "$($pathToProjectRoot)\out\$($DirName)\40"
Copy-Item -Path "$($pathToProjectRoot)\UIA\UIAutomationSpy\bin\Release35\*ninj*" -Destination "$($pathToProjectRoot)\out\$($DirName)\40"
...
Copy-Item -Path "$($pathToProjectRoot)\UIA\UIAutomationSpy\bin\Release35\*castle*" -Destination "$($pathToProjectRoot)\out\$($DirName)\Metro"
Copy-Item -Path "$($pathToProjectRoot)\UIA\UIAutomationSpy\bin\Release35\*access*" -Destination "$($pathToProjectRoot)\out\$($DirName)\Metro"
Copy-Item -Path "$($pathToProjectRoot)\UIA\UIAutomationSpy\bin\Release35\*ninj*" -Destination "$($pathToProjectRoot)\out\$($DirName)\Metro"
