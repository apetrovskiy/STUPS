...
New-UIAWizard -Name AddPrinterWizard `
    ...
    Add-UIAWizardStep -Name Step03ChooseSettings `
        ...
        -StepForwardAction { 
            (Get-UIARadioButton -Name "*add*manual*settings*").Select(); # | Set-UIARadioButtonToggleState $true;
    ...
    Add-UIAWizardStep -Name Step04ChoosePort `
        ...
        -StepForwardAction {
            (Get-UIARadioButton -Name "*create*new*port*").Select(); # | Set-UIARadioButtonToggleState $true;
    ...
    Add-UIAWizardStep -Name Step05PrinterData `
        ...
        -StepForwardAction {
            ...
            (Get-UIACheckBox -Name "*query*").Toggle($true); # | Set-UIACheckBoxToggleState $true;
            Get-UIAButton -AutomationId 'nextbutton' | Invoke-UIAButtonClick;
                           } `
        -StepBackwardAction $backwardAction `
        -StepCancelAction $cancelAction | `
    ...
    Add-UIAWizardStep -Name Step07AdditionalPortInformation `
        ...
        -StepForwardAction {
            (Get-UIARadioButton -Name "Standard").Select(); # | Set-UIARadioButtonToggleState $true;
    ...
    Add-UIAWizardStep -Name Step10DriverVersion `
        ...
        -StepForwardAction {
            (Get-UIARadioButton -Name '*Use*driver*currently*installed*recommended*').Select(); # | Set-UIARadioButtonToggleState $true;
            Get-UIAButton -AutomationId 'nextbutton' | Invoke-UIAButtonClick;
                           } `
        -StepBackwardAction $backwardAction `
        -StepCancelAction $cancelAction | `
    ...
    Add-UIAWizardStep -Name Step13PrinterSharing `
        ...
        -StepForwardAction {
            ...
            (Get-UIARadioButton -Name "*share*printer*others*can*find*").Select(); # | Set-UIARadioButtonToggleState $true;
    ...
    Add-UIAWizardStep -Name Step14Finish `
        ...
        -StepForwardAction {
            try {
                (Get-UIACheckBox -Name "*set*as*the*default*printer*").Toggle($true); # | Set-UIACheckBoxToggleState $true;
            }
            catch {}
